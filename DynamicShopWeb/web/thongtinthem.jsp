<%-- 
    Document   : thongtinthem
    Created on : Nov 5, 2016, 3:51:11 PM
    Author     : hv
--%>
        ...
        <div class="box">
            ...
            <div class="middle">
                <div class="text-widget">
                    <p>Cửa hàng chuyên cung cấp văn phòng phẩm, sách báo và tạp chí, đồ chơi và quà tặng... </p>
                </div>	
                <a class="read-more" title="Read More" href="#">Đọc thêm</a>
            </div>	
    ...
    <div class="box-holder middle">
        <div class="box">
            ...
            <div class="middle" id="newsletter">
                <div class="post">
                    <p><b><span>Thông tin đăng nhập</span></b></p>
                </div>
                <div class="cl"></div>
    ...
    <div class="box-holder right">
        <div class="box">
            ...
            <div class="middle post-short">
                <div class="post">
                    <p><b><span>Giảm giá 10%</span></b></p>
                    <p>Nhân dịp lễ 30/4, cửa hàng giảm giá 10% trên tất cả các sản phẩm.</p>
                    <a class="comments" href="#" title="comments">Đọc thêm</a>
                </div>
                <div class="date-box">
